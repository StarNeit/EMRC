UNIX BUILD NOTES
====================
Some notes on how to build EMRC in Unix.
...
memory available when compiling Emercury. With 512MB of memory or less
...
If you want to build EMRC-Qt, make sure that the required packages for Qt development
...
# Configure Emercury to use our own-built instance of BDB
cd $EMRC_ROOT
...
Security
--------
To help make your EMRC installation more secure by making certain attacks impossible to
