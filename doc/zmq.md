...
The Emercury daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Emercury requires ZeroMQ API version 4.x or
...
using. EMRCd appends an up-counting sequence number to each
