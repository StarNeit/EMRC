...
This mechanism has been integrated into Bitcore-Node-EMRC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EMRC-Project/insight-api-lux#web-socket-api](https://github.com/EMRC-Project/insight-api-lux#web-socket-api) 
* API: [https://github.com/EMRC-Project/insight-api-lux#instantx-transactions](https://github.com/EMRC-Project/insight-api-lux#instantx-transactions)
...
By default, the Emercury daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Emercury daemon:
