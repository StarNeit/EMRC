Contributing to Emercury
============================

The Emercury project operates an open contributor model where anyone is
...
The following applies to code changes to the Emercury project, and is not to be
confused with overall EMRC Network Protocol consensus changes.

Whether a pull request is merged into Emercury rests with the project merge
...
Patches that change EMRC consensus rules are considerably more involved than
...
Where a patch set proposes to change the EMRC consensus, it must have been
...
The project leader is the release manager for each Emercury release.
