...
Setup
---------
Configuring the github-merge tool for the EMRC repository is done in the following way:

    git config githubmerge.repository EMRC-Project/EMRC
...
A script to optimize png files in the EMRC
